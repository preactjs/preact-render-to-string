	...
	describe('Attribute casing', () => {
		...
		it('should have correct HTML casing', () => {
			let htmlAttributes = {
				...
				controls: 'controls',
				// controlsList: 'controlsList', // Seems to be only a property, not an attribute
				coords: 'coords',
				crossOrigin: 'crossorigin',
				data: 'data',
				dateTime: 'datetime',
				...
				dir: 'dir',
				disabled: 'disabled',
				// disableRemotePlayback: '', // Seems to be only a property, not an attribute
				download: 'download',
				decoding: 'decoding',
				draggable: 'draggable',
				encType: 'enctype',
				...
				integrity: 'integrity',
				is: 'is',
				// keyParams: '', // What is this?
				// keyType: '', // What is this?
				kind: 'kind',
				label: 'label',
				lang: 'lang',
				list: 'list',
